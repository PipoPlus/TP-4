...
public class RadioCompetition {
    ...
    private ServicioConcurso concursoServicio;

    public RadioCompetition(ServicioConcurso servicioConcurso) {

        this.concursoServicio = servicioConcurso;
        inicio();
    ...
    private void cargarTodosLosConcursos() {
        List<Concurso> concursos = concursoServicio.todosLosConcursos();
        comboBox.addItem("Seleccionar...");
        for (Concurso concurso : concursos) {
            comboBox.addItem(concurso.getNombreConcurso());
        }
    }
    ...
    private void guardarInscripcion(){
        if(validations()){
            ...
            String nombreConcurso = (String) comboBox.getSelectedItem();
            concursoServicio.guardarInscripcion(nombre,apellido,id,telefono,email,nombreConcurso);
        }
    }
